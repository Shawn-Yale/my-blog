...
```
## [P1894 [USACO4.2] 完美的牛栏The Perfect Stall](https://www.luogu.com.cn/problem/P1894)(二分图匹配)
```cpp
#include <bits/stdc++.h>
using namespace std;
#define endl '\n'
...
```
## [P2071 座位安排](https://www.luogu.com.cn/problem/P2071)(二分图匹配)
...
```
## [P1129 [ZJOI2007] 矩阵游戏](https://www.luogu.com.cn/problem/P1129)(二分图匹配)
...
## [P2055 [ZJOI2009] 假期的宿舍](https://www.luogu.com.cn/problem/P2055)(二分图匹配)
```cpp
#include <bits/stdc++.h>
using namespace std;
#define endl '\n'
